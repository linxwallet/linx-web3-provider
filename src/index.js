...
if (typeof context.LinxWallet === 'undefined') {
  context.LinxWallet = LinxWallet
}
...
ProviderEngine.prototype.send = function (payload) {
  ...
  switch (payload.method) {
    ...
    default:
      var message = `The LinxWallet Web3 object does not support synchronous methods like ${payload.method} without a callback parameter.`
